...
/obj/item/clothing/neck/tooth_necklace
	name = "necklace"
	w_class = 2
...
/obj/item/clothing/neck/tooth_necklace/New()
	..()
	update_icon()

/obj/item/clothing/neck/tooth_necklace/update_icon()
...
/obj/item/clothing/neck/tooth_necklace/examine(mob/user)
	..()
	user << "It contains:"
	for(var/obj/item/I in ornaments)
		var/getname = I.name
...
/obj/item/clothing/neck/tooth_necklace/attack_self(mob/user)
	if(ornaments.len)
		user << "You shuffle the ornaments on the necklace."
		ornaments = shuffle(ornaments)
		update_icon()

/obj/item/clothing/neck/tooth_necklace/attackby(obj/item/W, mob/user)
...
/obj/item/stack/teeth/attackby(obj/item/W, mob/user)
	if(istype(W, /obj/item/stack/cable_coil))
		...
		if(C.amount < 4)
			...
			return
		var/obj/item/clothing/neck/tooth_necklace/N = new (usr.loc)
